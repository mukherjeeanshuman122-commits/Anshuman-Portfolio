...
function Divider() {
  return (
    <div className="relative h-16 flex items-center justify-center">
      <div className="w-48 h-[1px] bg-gradient-to-r from-transparent via-indigo-mid/25 to-transparent" />
      <div className="absolute w-1 h-1 rounded-full" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.5), rgba(139,92,246,0.5))' }} />
    </div>
  )
}
