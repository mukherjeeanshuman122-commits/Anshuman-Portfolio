...
function SocialIcon({ href, children }) {
  return (
    <a href={href} target="_blank" rel="noopener noreferrer"
      className="p-2 bg-white/5 text-white/45 transition-all duration-300 hover:bg-white/10 hover:text-white/65 hover:-translate-y-0.5 active:scale-95"
      style={{ border: '1px solid rgba(255,255,255,0.06)', borderRadius: '3px' }}>
      {children}
    </a>
  )
}
...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden" style={{ borderTop: '1px solid rgba(255,255,255,0.04)' }}>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              <span className="relative flex h-1.5 w-1.5">
                ...
                <span className="relative inline-flex h-1.5 w-1.5 bg-bone/45" />
              </span>
