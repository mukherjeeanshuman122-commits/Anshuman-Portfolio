  ...
  return (
    <group ref={groupRef}>
      <mesh rotation={[Math.PI / 2, 0, 0]}>
        ...
        <meshStandardMaterial color="#1A1A1A" emissive="#2D0A0A" emissiveIntensity={0.08} transparent opacity={0.08} />
      </mesh>
...
export default function HeroScene() {
  return (
    <Canvas camera={{ position: [0, 0.3, 4.5], fov: 40 }} dpr={[1, 1.5]}>
      ...
      <directionalLight position={[-3, -2, -3]} intensity={0.15} color="#5C1A1A" />
