  ...
  const createSlash = useCallback((clientX, clientY) => {
    ...
    slash.innerHTML = `
      <svg width="200" height="60" viewBox="0 0 200 60" fill="none">
        ...
        <line x1="0" y1="30" x2="200" y2="30" stroke="rgba(139,32,32,0.5)" stroke-width="1.5" stroke-dasharray="200" stroke-dashoffset="200"/>
        ...
        <path d="M 50 31 L 160 28" stroke="rgba(139,32,32,0.4)" stroke-width="1" stroke-linecap="round" stroke-dasharray="110" stroke-dashoffset="110"/>
        <rect x="2" y="22" width="12" height="16" rx="1" fill="rgba(60,50,40,0.9)" stroke="rgba(139,32,32,0.3)" stroke-width="0.5"/>
      ...
      <svg class="fixed inset-0 w-full h-full" style="pointer-events:none">
        <defs>
          <linearGradient id="tg-${Date.now()}" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stop-color="rgba(139,32,32,0.5)"/>
            <stop offset="100%" stop-color="rgba(139,32,32,0)"/>
          </linearGradient>
        </defs>
    ...
    flash.style.cssText = `position:fixed;inset:0;pointer-events:none;z-index:9996;background:radial-gradient(ellipse at center, rgba(139,32,32,0.08), transparent 70%);opacity:0.15;`
