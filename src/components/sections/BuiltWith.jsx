    ...
    <section ref={sectionRef} className="relative py-24">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 liquid-glass rounded-xl text-[10px] font-mono text-white/30" style={{ borderColor: 'rgba(99,102,241,0.12)' }}>
            <span className="w-1.5 h-1.5" style={{ background: 'linear-gradient(135deg, #3b82f6, #8b5cf6)' }} />
