        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          {techStack.map((tech) => (
            <div key={tech.name} className="tech-item liquid-glass rounded-xl p-4 text-center group cursor-default card-hover">
              <div className="w-10 h-10 mx-auto mb-2 text-white/50 group-hover:text-white/80 transition-all duration-300 group-hover:scale-110" style={{ color: tech.color + '80' }}>
                {tech.svg}
              </div>
