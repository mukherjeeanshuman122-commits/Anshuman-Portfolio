  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden pt-24">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full animate-[spin_45s_linear_infinite]"
          data-speed="0.2"
          style={{ border: '1px solid rgba(99,102,241,0.05)' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[480px] h-[480px] rounded-full animate-[spin_35s_linear_infinite_reverse]"
          data-speed="0.3"
          style={{ border: '1px solid rgba(139,92,246,0.04)' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] rounded-full animate-[spin_90s_linear_infinite]"
          data-speed="0.05"
      ...
      <div ref={heroRef} className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            <div style={{ animation: 'fadeInUp 0.8s cubic-bezier(0.16,1,0.3,1) 0.2s both' }}>
            ...
            <div className="space-y-4">
              <h1 className="text-5xl sm:text-7xl lg:text-8xl xl:text-9xl font-bold leading-[0.85] tracking-tight">
                <span className="block"><TextReveal text="Building" className="text-white/90" delay={0.1} /></span>
                <GlitchText text="Digital" as="span" className="block gradient-text drop-shadow-[0_0_30px_rgba(99,102,241,0.4)]" intensity="high" />
                <span className="block"><TextReveal text="Experiences" className="text-white/90" delay={0.3} /></span>
              </h1>

              <div className="h-12 sm:h-14 overflow-hidden">
                <span className="text-xl sm:text-2xl text-white/60 font-light">That feel alive — </span>
            ...
            <p className="text-lg sm:text-xl text-white/65 leading-relaxed max-w-xl" style={{ opacity: 0, animation: 'fadeInUp 0.8s cubic-bezier(0.16,1,0.3,1) 0.5s both', animationFillMode: 'both' }}>
            ...
            <div className="flex flex-wrap gap-4">
              <MagneticButton
                ...
                className="px-8 py-3.5 text-sm font-semibold text-bone transition-all duration-400 font-mono relative overflow-hidden group"
                style={{
              ...
              <MagneticButton
                ...
                className="px-8 py-3.5 text-sm font-semibold glass hover:bg-white/5 transition-all duration-400 font-mono"
              ...
              {stats.map((stat, i) => (
                <div key={i} className="space-y-1 group">
                  <AnimatedCounter
                    target={stat.target}
                    suffix={stat.suffix}
                    className="text-2xl sm:text-3xl font-bold text-white/85 group-hover:text-bone transition-colors duration-400"
                  />
                  <ScrambleText text={stat.label} className="text-xs text-white/60 font-mono" />
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-[subtleBounce_2s_ease-in-out_infinite]">
        <span className="text-[10px] text-white/55 font-mono tracking-[0.3em]">SCROLL</span>
        <div
