    ...
    <section className="relative py-32 overflow-hidden" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative h-[400px] flex items-center justify-center orbit-container">
          ...
          <div className="absolute w-[300px] h-[300px] rounded-full border" style={{ borderColor: 'rgba(99,102,241,0.08)' }} />
          <div className="absolute w-[450px] h-[450px] rounded-full border" style={{ borderColor: 'rgba(99,102,241,0.06)' }} />
          ...
          <div className="absolute w-[450px] h-[450px] animate-[spin_45s_linear_infinite_reverse]">
            {orbitTechs.slice(8).map((tech, i) => {
              ...
              const logo = toolLogos[tech.name]
              return (
                <div key={tech.name} className="absolute w-10 h-10 -ml-5 -mt-5 rounded-lg flex items-center justify-center group cursor-pointer hover:scale-130 transition-transform duration-200"
                  style={{ left: `calc(50% + ${x}px)`, top: `calc(50% + ${y}px)`, animation: 'spin 45s linear infinite reverse', background: 'rgba(99,102,241,0.06)', border: '1px solid rgba(99,102,241,0.1)' }}>
