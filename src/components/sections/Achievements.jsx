  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      <svg className="w-full h-full -rotate-90" viewBox={`0 0 ${size} ${size}`}>
        ...
        <circle cx={size / 2} cy={size / 2} r={radius} fill="none" stroke="#7231EC" strokeWidth={strokeWidth}
...
function Sparkline() {
  ...
  return (
    <svg className="w-full h-8 mt-2" viewBox="0 0 100 50" preserveAspectRatio="none">
      <defs><linearGradient id="spark-danger" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#7231EC" stopOpacity="0.2" /><stop offset="100%" stopColor="#7231EC" stopOpacity="0" /></linearGradient></defs>
      <path d={pathD} fill="none" stroke="#7231EC" strokeWidth="1.5" />
