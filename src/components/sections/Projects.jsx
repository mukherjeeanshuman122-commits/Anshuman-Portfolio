        ...
        <div className="relative group cursor-pointer" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} style={{ perspective: '1000px' }}>
          <div className="relative overflow-hidden"
            ...
            <div className="aspect-video flex items-center justify-center relative overflow-hidden"
              ...
              >
                <div className="flex justify-center text-white/40 mb-4 drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]">{icons[project.title] || <div className="w-16 h-16" />}</div>
                <p className="text-white/40 text-[10px] font-mono uppercase tracking-[0.2em]">{project.type}</p>
                <p className="text-blood/80 text-[11px] mt-2 font-mono drop-shadow-[0_0_8px_rgba(78,38,226,0.5)]">{project.tags[0]}</p>
              </div>
              <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ background: `radial-gradient(500px circle at ${glow.x}px ${glow.y}px, rgba(78,38,226,0.15), transparent 40%)`, mixBlendMode: 'screen' }} />
              <div className="absolute top-4 left-4 w-8 h-8 border-l-2 border-t-2 border-white/20 transition-all duration-300 group-hover:border-blood/60 group-hover:-translate-x-1 group-hover:-translate-y-1" style={{ transform: 'translateZ(20px)' }} />
              <div className="absolute bottom-4 right-4 w-8 h-8 border-r-2 border-b-2 border-white/20 transition-all duration-300 group-hover:border-blood/60 group-hover:translate-x-1 group-hover:translatey-1" style={{ transform: 'translateZ(20px)' }} />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            <MagneticButton as="a" href={project.liveUrl} className="px-6 py-2.5 text-sm font-semibold text-bone transition-all duration-200 font-mono"
              style={{ background: 'rgba(78,38,226,0.18)', border: '1px solid rgba(78,38,226,0.3)' }}>
