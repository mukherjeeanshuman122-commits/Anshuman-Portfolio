  ...
  return (
    <div className="relative w-20 h-20">
      <svg className="w-full h-full -rotate-90" viewBox="0 0 80 80">
        <circle cx="40" cy="40" r="36" fill="none" stroke="rgba(99,102,241,0.08)" strokeWidth="4" />
  ...
  return (
    <section ref={sectionRef} className="relative py-24">
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <div className="lighthouse-card rounded-2xl p-8" style={{ background: 'rgba(10,15,46,0.6)', border: '1px solid rgba(99,102,241,0.08)' }}>
          ...
          <div className="mt-6 pt-6 text-center" style={{ borderTop: '1px solid rgba(99,102,241,0.08)' }}>
