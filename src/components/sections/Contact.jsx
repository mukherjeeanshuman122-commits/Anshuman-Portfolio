  ...
  return (
    <div className="relative group">
      <div className="absolute -inset-px rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
        style={{ background: 'linear-gradient(135deg, rgba(139,32,32,0.15), transparent 40%, rgba(139,32,32,0.08))' }} />
      <div className="relative">
        <div className="absolute left-4 top-1/2 -translate-y-1/2 transition-all duration-300 pointer-events-none"
          style={{ color: focused ? 'rgba(179,48,48,0.8)' : 'rgba(255,255,255,0.2)', transform: isActive ? 'translateY(-24px) scale(0.7)' : 'translateY(-50%) scale(1)', left: '16px', transformOrigin: 'left center' }}>
          {icon}
        </div>
        <input
        ...
        <label className="absolute left-11 transition-all duration-300 pointer-events-none font-mono"
          style={{
            ...
            color: focused ? 'rgba(179,48,48,0.9)' : 'rgba(255,255,255,0.35)',
            fontSize: '10px',
            letterSpacing: '0.1em',
        ...
        <div className="absolute bottom-0 left-4 right-4 h-[1px] overflow-hidden rounded-full">
          <div className="h-full transition-all duration-500 ease-out"
            style={{
              width: focused ? '100%' : '0%',
              background: 'linear-gradient(90deg, rgba(139,32,32,0.6), rgba(179,48,48,0.4), rgba(139,32,32,0.6))',
            }} />
        </div>
      </div>
    </div>
    ...
    <div className="relative group">
      ...
      <div className="relative">
        <div className="absolute left-4 top-5 transition-all duration-300 pointer-events-none"
          style={{ color: focused ? 'rgba(179,48,48,0.8)' : 'rgba(255,255,255,0.2)' }}>
          ...
          <div className="w-16 h-[2px] bg-white/5 rounded-full overflow-hidden">
            <div className="h-full rounded-full transition-all duration-300"
              style={{
                ...
                background: charPercent > 90 ? 'rgba(239,68,68,0.7)' : charPercent > 70 ? 'rgba(234,179,8,0.6)' : 'rgba(139,32,32,0.5)',
              }} />
          </div>
    ...
    <button ref={btnRef} type="submit" disabled={sending || submitted}
      ...
      <div className="absolute inset-0 rounded-xl" style={{
        background: submitted
          ...
          : 'linear-gradient(135deg, rgba(139,32,32,0.25), rgba(179,48,48,0.15), rgba(139,32,32,0.25))',
        border: `1px solid ${submitted ? 'rgba(34,197,94,0.2)' : 'rgba(139,32,32,0.3)'}`,
      }} />
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-xl"
        style={{ background: 'radial-gradient(circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(179,48,48,0.15), transparent 60%)' }} />
      <div className="absolute inset-0 rounded-xl overflow-hidden">
        <div className="absolute -top-1/2 -left-1/2 w-[200%] h-[200%] opacity-0 group-hover:opacity-100 transition-opacity duration-700"
          style={{ background: 'conic-gradient(from 0deg, transparent, rgba(139,32,32,0.1), transparent 30%)', animation: 'spin 4s linear infinite' }} />
      </div>
...
function ContactCard({ icon, label, value, href, onClick, delay = 0 }) {
  ...
  return (
    <div ref={cardRef}
      ...
      style={{
        background: hovered ? 'rgba(139,32,32,0.06)' : 'rgba(255,255,255,0.02)',
        border: `1px solid ${hovered ? 'rgba(139,32,32,0.2)' : 'rgba(255,255,255,0.04)'}`,
      }}>
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300"
          style={{
            background: hovered ? 'rgba(139,32,32,0.15)' : 'rgba(255,255,255,0.04)',
            border: `1px solid ${hovered ? 'rgba(139,32,32,0.25)' : 'rgba(255,255,255,0.06)'}`,
          }}>
          {icon}
        </div>
    ...
    <div ref={overlayRef} className="absolute inset-0 z-50 flex items-center justify-center rounded-2xl overflow-hidden"
      ...
      {[...Array(12)].map((_, i) => (
        <div key={i} className="success-particle absolute w-1 h-1 rounded-full"
          style={{
            background: i % 3 === 0 ? '#8B2020' : i % 3 === 1 ? '#E8E4D9' : '#B33030',
            top: '50%', left: '50%',
          ...
          <div className="lg:col-span-8 contact-form-panel">
            <div className="liquid-glass rounded-2xl p-8 relative overflow-hidden">
              ...
              <div className="absolute top-0 right-0 w-32 h-32 pointer-events-none opacity-40"
                style={{ background: 'radial-gradient(circle, rgba(139,32,32,0.08), transparent 70%)' }} />

              <div className="flex items-center gap-2 mb-6">
                <div className="w-8 h-8 rounded-lg flex items-center justify-center"
                  style={{ background: 'rgba(139,32,32,0.1)', border: '1px solid rgba(139,32,32,0.15)' }}>
