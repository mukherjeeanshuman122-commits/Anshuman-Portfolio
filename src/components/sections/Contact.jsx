    ...
    <div className="relative group">
      ...
      <div className="relative">
        <div className="absolute left-4 top-1/2 -translate-y-1/2 transition-all duration-300 pointer-events-none"
          style={{ color: focused ? 'rgba(129,140,248,0.9)' : 'rgba(226,232,240,0.2)', transform: isActive ? 'translateY(-24px) scale(0.7)' : 'translateY(-50%) scale(1)', left: '16px', transformOrigin: 'left center' }}>
          {icon}
        </div>
        <input
        ...
        <label className="absolute left-11 transition-all duration-300 pointer-events-none font-mono"
          style={{
            ...
            color: focused ? 'rgba(129,140,248,0.95)' : 'rgba(226,232,240,0.3)',
            fontSize: '10px',
            letterSpacing: '0.1em',
    ...
    <div className="relative group">
      ...
      <div className="relative">
        <div className="absolute left-4 top-5 transition-all duration-300 pointer-events-none"
          style={{ color: focused ? 'rgba(129,140,248,0.9)' : 'rgba(226,232,240,0.2)' }}>
      ...
      <div className="flex justify-between items-center mt-2 px-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] font-mono" style={{ color: charPercent > 90 ? 'rgba(239,68,68,0.7)' : 'rgba(226,232,240,0.2)' }}>
            {charCount}/{maxLength}
          </span>
        </div>
      </div>
