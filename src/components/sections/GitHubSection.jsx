...
function ContributionHeatmap() {
  ...
  const colors = ['rgba(99,102,241,0.03)', 'rgba(59,130,246,0.1)', 'rgba(99,102,241,0.18)', 'rgba(139,92,246,0.28)', 'rgba(99,102,241,0.45)']
  return (
  ...
  return (
    <section id="github" className="relative py-32" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="rounded-2xl overflow-hidden max-w-3xl mx-auto terminal-card" style={{ background: 'rgba(10,15,46,0.6)', border: '1px solid rgba(99,102,241,0.08)' }}>
          <div className="flex items-center gap-2 px-4 py-3 border-b bg-black/20" style={{ borderColor: 'rgba(99,102,241,0.08)' }}>
            <div className="flex gap-1.5"><span className="w-2.5 h-2.5 rounded-full" style={{ background: 'linear-gradient(135deg, #3b82f6, #8b5cf6)' }} /><span className="w-2.5 h-2.5 rounded-full bg-white/12" /><span className="w-2.5 h-2.5 rounded-full bg-white/12" /></div>
